...
class BodyUpscaleUpscalePostImageTypedDict(TypedDict):
    file_name: str
    content: Union[bytes, IO[bytes], io.BufferedReader]
    content_type: NotRequired[str]
    

class BodyUpscaleUpscalePostImage(BaseModel):
...
class BodyUpscaleUpscalePostTypedDict(TypedDict):
    prompt: str
    r"""Text prompt(s) to guide upscaled image generation."""
    image: BodyUpscaleUpscalePostImageTypedDict
...
class BodyUpscaleUpscalePost(BaseModel):
    prompt: Annotated[str, FieldMetadata(multipart=True)]
    r"""Text prompt(s) to guide upscaled image generation."""
    image: Annotated[BodyUpscaleUpscalePostImage, pydantic.Field(alias=""), FieldMetadata(multipart=MultipartFormMetadata(file=True))]
    r"""Uploaded image to modify with the pipeline."""
