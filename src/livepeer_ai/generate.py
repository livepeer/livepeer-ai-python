...
from livepeer_ai.utils.unmarshal_json_response import unmarshal_json_response
    ...
    def text_to_image(
        ...
        *,
        ...
        if utils.match_response(http_res, ["400", "401"], "application/json"):
            response_data = unmarshal_json_response(errors.HTTPErrorData, http_res)
            raise errors.HTTPError(response_data, http_res)
